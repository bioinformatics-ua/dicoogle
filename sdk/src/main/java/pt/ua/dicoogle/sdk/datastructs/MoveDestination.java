...
public class MoveDestination implements Serializable {
    ...
    @JsonCreator
    public MoveDestination(@JsonProperty("aetitle") String AETitle, @JsonProperty("address") String ipAddr, @JsonProperty("port") int port,
            @JsonProperty("public") boolean isPublic, @JsonProperty("description") String description) {
    ...
    public boolean equals(Object o) {
        ...
        return port == that.port && isPublic == that.isPublic && Objects.equals(AETitle, that.AETitle) && Objects.equals(ipAddrs, that.ipAddrs)
