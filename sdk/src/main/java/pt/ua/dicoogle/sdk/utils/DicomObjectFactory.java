...
public class DicomObjectFactory {
    ...
    public static Object toObject(Path parentPath, DicomElement elem, SpecificCharacterSet cs) {
        ...
        if (vr == VR.AE || vr == VR.AE || vr == VR.AS || vr == VR.AT || vr == VR.CS || vr == VR.DA || vr == VR.DS || vr == VR.DT || vr == VR.IS || vr == VR.LO
                || vr == VR.LT || vr == VR.PN || vr == VR.SH || vr == VR.ST || vr == VR.TM || vr == VR.UI || vr == VR.UT) {
