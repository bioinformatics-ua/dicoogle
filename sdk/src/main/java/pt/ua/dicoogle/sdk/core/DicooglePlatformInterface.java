 ...
 * <p>
 * For instance, if a graphical plugin needs to query, it will able to access to
 * other plugins with this platform.
 *
 *
...
public interface DicooglePlatformInterface {
     ...
     * @return IndexerInterface class of the plugin that implements this
     * interface
     */
