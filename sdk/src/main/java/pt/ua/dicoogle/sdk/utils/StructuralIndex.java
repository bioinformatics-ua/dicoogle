...
public class StructuralIndex {
    ...
    static int[][] lookupTable = new int[][] {new int[] {1, 1, 1}, new int[] {2, 130, 128}, new int[] {131, 8323, 64}, new int[] {8324, 270468, 32},
            new int[] {270469, 4464773, 16}, new int[] {4464774, 71573638, 16}, new int[] {71573639, 1145315463, 16},};
