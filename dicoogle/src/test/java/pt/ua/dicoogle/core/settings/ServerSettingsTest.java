...
public class ServerSettingsTest {
    ...
    public void test() throws IOException {
        ...
        // default
        Collection<String> defaultTS = Arrays.asList("1.2.840.10008.1.2", "1.2.840.10008.1.2.1", "1.2.840.10008.1.2.4.80", "1.2.840.10008.1.2.4.50");
        assertSameContent(defaultTS, ((DicomServicesImpl) dcm).getDefaultTransferSyntaxes());

        Collection<SOPClass> sopClasses = Arrays.asList(new SOPClass("1.2.840.10008.5.1.4.1.1.88.40", Collections.EMPTY_LIST),
                new SOPClass("1.2.840.10008.5.1.4.1.1.77.1.1", Collections.EMPTY_LIST),
                new SOPClass("1.2.840.10008.5.1.4.1.1.12.1.1", Arrays.asList("1.2.840.10008.1.2", "1.2.840.10008.1.2.1", "1.2.840.10008.1.2.5")));
        ...
        */
        ...
        List<MoveDestination> destinations =
                Collections.singletonList(new MoveDestination("ANOTHER-STORAGE", "192.168.42.42", 6666, false, "Our test storage"));
    ...
    public void testDefaultSettings() throws IOException {
        ...
        // default
        Collection<String> defaultTS = Arrays.asList("1.2.840.10008.1.2", "1.2.840.10008.1.2.1", "1.2.840.10008.1.2.2", "1.2.840.10008.1.2.4.70",
                "1.2.840.10008.1.2.4.80", "1.2.840.10008.1.2.4.57", "1.2.840.10008.1.2.4.90", "1.2.840.10008.1.2.4.91", "1.2.840.10008.1.2.5",
        ...
        assertSameContent(Arrays.asList("1.2.840.10008.1.2", "1.2.840.10008.1.2.2", "1.2.840.10008.1.2.1"), qr.getTransferCapabilities());
        assertSameContent(Arrays.asList("1.2.840.10008.5.1.4.1.2.2.1", "1.2.840.10008.5.1.4.1.2.1.1"), qr.getSOPClass());
    ...
    public void testMigrate() throws IOException {
        ...
        Collection<SOPClass> sopClasses = Arrays.asList(
                new SOPClass("1.2.840.10008.5.1.4.1.1.88.40",
                        Arrays.asList("1.2.840.10008.1.2", "1.2.840.10008.1.2.1", "1.2.840.10008.1.2.4.80", "1.2.840.10008.1.2.4.50")),
                new SOPClass("1.2.840.10008.5.1.4.1.1.77.1.1",
                        Arrays.asList("1.2.840.10008.1.2", "1.2.840.10008.1.2.1", "1.2.840.10008.1.2.4.80", "1.2.840.10008.1.2.4.50")),
                new SOPClass("1.2.840.10008.5.1.1.30",
                        Arrays.asList("1.2.840.10008.1.2", "1.2.840.10008.1.2.1", "1.2.840.10008.1.2.4.80", "1.2.840.10008.1.2.4.50")));

        Collection<SOPClass> sopClassesFromSettings =
                settings.getDicomServicesSettings().getSOPClasses().stream().filter(c -> !c.getTransferSyntaxes().isEmpty()).collect(Collectors.toList());
