...
var HTMLDicoogleSlotElement = (function () {
  ...
  document.registerElement("dicoogle-slot", {
    prototype: Object.create(HTMLDivElement.prototype, {
      slotId: {
        get: function get() {
          return this.attributes["slot-id"] ? this.attributes["slot-id"].value : null;
        }
      },
      ...
      //      var attSlotId = this.attributes['slot-id'];
      //      if (!attSlotId || !attSlotId.value || attSlotId === '') {
      //        throw "Dicoogle slot contains illegal slot-id";
      //      }
...
module.exports = (function () {
  ...
  m.HTMLDicoogleSlotElement.prototype.addEventListener("inserted", function () {
    var attSlotId = this.attributes["slot-id"];
    if (!attSlotId || !attSlotId.value || attSlotId === "") {
      console.error("Dicoogle slot contains illegal slot-id!");
    }
    console.log("[CALLBACK] Dicoogle slot attached: ", this);
  });
  ...
  m.loadSlot = function (slotDOM) {
    ...
    if (!elemAttributes["slot-id"]) {
      console.error("Dicoogle web UI slot lacking id attribute!");
      return;
    }
    var id = elemAttributes["slot-id"].value;
  ...
  m.request = function (service, arg1, arg2) {
    ...
    $.getJSON(base_url + service, data).done(function (result) {
  ...
  // ----------------------------------------------------------------------------
  // TODO integrate with HTMLDicoogleSlotElement
  ...
  function dispatch_result(result, plugins) {
    ...
    for (var i = 0; i < eventListeners.result.length; i++) {
      eventListeners.result[i](result);
    }
  }
