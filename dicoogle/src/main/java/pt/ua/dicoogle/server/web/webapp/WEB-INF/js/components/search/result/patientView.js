  ...
  onPatientClick: function(item){
    ...
    return (
        ...
        <BootstrapTable data={resultArray} selectRow={selectRowProp} pagination striped hover width="100%">
          <TableHeaderColumn dataAlign="right" dataField="id" width="25%" isKey dataFormat={this.formatID} dataSort>ID</TableHeaderColumn>
          <TableHeaderColumn dataAlign="left" dataField="name" dataFormat={this.formatName} width="50%" isKey={false} dataSort>Name</TableHeaderColumn>
          <TableHeaderColumn dataAlign="center" dataField="gender" dataFormat={this.formatGender} width="12%" dataSort>Gender</TableHeaderColumn>
