...
public class IndexerServlet extends HttpServlet {
     ...
     */
    private static void writeXMLToResponse(String xml, HttpServletResponse response, boolean allowCache) throws IOException {
     ...
     */
    public static String getHTMLServiceAdvancedSettingsForm(HttpServletRequest request, String brokerURL, String elementID) throws IOException {
        String result = "";
    ...
    private static String getHTMLAdvancedSettingsFormRow(String name, Object value, String help) {
        ...
        result += "<td>" + Utils.getHTMLInputFromType(id, value) + getHTMLSettingHelp(escapeHtml4(name), help) + "</td>"; // TODO add a button with help, like
                                                                                                                          // in the desktop application
                                                                                                                          // [getHelpForParam(pluginName,
                                                                                                                          // paramName) != null]
