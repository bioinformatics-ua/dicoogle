...
function SmartWizard(target, options) {
    ...
    this.otherButtons = new Array();
    this.otherButtonsCallbacks = new Array();
    for(var i in options.otherButtons){
    	this.otherButtons[i] = $('<a id="'+options.otherButtons[i].id+'">'+options.otherButtons[i].label+'</a>').attr("href","#").addClass("otherButton").addClass(options.otherButtons[i].className);
    	this.otherButtonsCallbacks[i] = options.otherButtons[i].funct;
    }
    ...
    var _init = function($this) {
        ...
        for(var i in $this.otherButtons){
        	elmActionBar.append($this.otherButtons[i]);
        }
        ...
        //Appending Hook Functions to extra Buttons;
        for(i in $this.otherButtons){
        	$($this.otherButtons[i]).click(function() {
                $this.otherButtonsCallbacks[i]();
                return false;
            });
        }
