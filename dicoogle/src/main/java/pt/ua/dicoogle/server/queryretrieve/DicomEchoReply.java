...
public class DicomEchoReply extends VerificationService {
    ...
    public DicomEchoReply() {
        ...
        TransferCapability[] tc = {new TransferCapability(DicomEchoReply.SOP_CLASS, DicomEchoReply.TRANSF_CAP, TransferCapability.SCP)};
    ...
    public void setTransferSyntax(String[] ts) {
        TransferCapability[] tc = {new TransferCapability(UID.ModalityWorklistInformationModelFIND, ts, TransferCapability.SCU)};
        this.localAE.setTransferCapability(tc);
    }
