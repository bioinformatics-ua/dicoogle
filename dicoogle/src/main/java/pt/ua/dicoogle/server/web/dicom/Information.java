...
public class Information {
     ...
     * @return a Hashtables containing all name and value tag pairs for the respective .dcm file if the SOP Instance UID is valid and indexed, null otherwise.
     */
    public static HashMap<String, Object> searchForFileIndexedMetaData(String sopInstanceUID, List<String> providers) // XXX SOP Instance UID should always be
                                                                                                                      // set within a DICOM file, I think...
    {
        if (sopInstanceUID == null)
            return null;
