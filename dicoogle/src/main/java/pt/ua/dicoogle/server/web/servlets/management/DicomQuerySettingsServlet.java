...
public class DicomQuerySettingsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ServerSettings.DicomServices.QueryRetrieve ss = ServerSettingsManager.getSettings().getDicomServicesSettings().getQueryRetrieveSettings();
        ...
        QueryRetrieveSettingsObject queryRetrieveSettings =
                new QueryRetrieveSettingsObject(responseTimeout, connectionTimeout, idleTimeout, acceptTimeout, maxPduSend, maxPduReceive, maxAssociations);
    ...
    public static class QueryRetrieveSettingsObject {
        private int responseTimeout, connectionTimeout, idleTimeout, acceptTimeout, maxPduSend, maxPduReceive, maxAssociations;

        public QueryRetrieveSettingsObject() {}

        public QueryRetrieveSettingsObject(int responseTimeout, int connectionTimeout, int idleTimeout, int acceptTimeout, int maxPduSend, int maxPduReceive,
                int maxAssociations) {
            super();
