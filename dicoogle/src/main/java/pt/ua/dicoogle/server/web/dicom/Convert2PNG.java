...
public class Convert2PNG {
     ...
     */
    @Deprecated
    public static ByteArrayOutputStream DICOM2PNGStream(StorageInputStream dcmStream, int frameIndex, int transformType, int transformParam1,
        ...
        DicomImageReadParam readParams = (DicomImageReadParam) reader.getDefaultReadParam(); // and set the default params for it (height, weight, alpha) //
        ...
        try {
            ...
            if ((frameCount < 1) || (frameIndex < 0) || (frameIndex >= frameCount)) // if teither the file has no frames or the frame wanted is outside of
                                                                                    // bounds abort
                return null;
    ...
    public static BufferedImage scaleImageByWidth(BufferedImage image, int width) {
        ...
        BufferedImage result = new BufferedImage(scaledImage.getWidth(null), scaledImage.getHeight(null), BufferedImage.TYPE_INT_RGB); // create the output
                                                                                                                                       // image
