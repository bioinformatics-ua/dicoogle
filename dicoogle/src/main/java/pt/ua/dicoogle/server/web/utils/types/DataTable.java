...
public class DataTable {
    ...
    public synchronized String toHTMLString(String htmlElementID) {
        ...
        for (int row = 0; row < data.length; row++) {
            ...
            result += "<button type=\"button\" class=\"removeButton\" onclick=\"removeDataTableRow(this.parentNode.parentNode, this.parentNode);\" "
        ...
        result += "<button type=\"button\" onclick=\"addDataTableRow(document.getElementById('" + htmlElementID + "'));\">Add</button><br />"; // FIXME replace
                                                                                                                                               // the
                                                                                                                                               // getelementbyid
                                                                                                                                               // with
