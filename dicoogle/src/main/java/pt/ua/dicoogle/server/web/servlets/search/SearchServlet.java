...
public class SearchServlet extends HttpServlet {
    ...
    private final Collection<String> DEFAULT_FIELDS = Arrays.asList("SOPInstanceUID", "StudyInstanceUID", "SeriesInstanceUID", "PatientID", "PatientName",
            "PatientSex", "Modality", "StudyDate", "StudyID", "StudyDescription", "SeriesNumber", "SeriesDescription", "InstitutionName", "uri");
        ...
        if (paramDepth != null) {
            ...
            switch (paramDepth.toLowerCase()) {
                ...
                case "image":
                    ...
                    break;
                default:
                    sendError(response, 400, "Invalid parameter depth: must be a valid level: " + "'none', 'patient', 'study', 'series' or 'image'");
                    return;
            }
        } else {
            depth = 4;
    ...
    private void writeResponse(HttpServletResponse resp, Iterable<SearchResult> results, long elapsedTime, int offset, int psize)
