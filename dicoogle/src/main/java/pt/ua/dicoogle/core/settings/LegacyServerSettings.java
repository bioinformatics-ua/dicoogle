...
@JsonAutoDetect(getterVisibility = JsonAutoDetect.Visibility.NONE, isGetterVisibility = JsonAutoDetect.Visibility.NONE,
        setterVisibility = JsonAutoDetect.Visibility.NONE, fieldVisibility = JsonAutoDetect.Visibility.NONE, creatorVisibility = JsonAutoDetect.Visibility.NONE)
@JsonRootName("config")
public class LegacyServerSettings implements ServerSettings {
     ...
     */
    private final ConcurrentHashMap<String, Boolean> autoStartPlugin; // NOTE the concurrent hash map is used to prevent having to synchronize the methods that
                                                                      // use it
    ...
    public LegacyServerSettings() {
        ...
        this.sopClass = UID.StudyRootQueryRetrieveInformationModelFIND + "|" + UID.PatientRootQueryRetrieveInformationModelFIND;
    ...
    @JsonAutoDetect(isGetterVisibility = JsonAutoDetect.Visibility.ANY, getterVisibility = JsonAutoDetect.Visibility.ANY,
