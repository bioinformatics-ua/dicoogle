...
public class DicomServicesImpl implements ServerSettings.DicomServices {
    public static DicomServicesImpl createDefault() {
        ...
        s.defaultTS = Arrays.asList("1.2.840.10008.1.2", "1.2.840.10008.1.2.1", "1.2.840.10008.1.2.2", "1.2.840.10008.1.2.4.70", "1.2.840.10008.1.2.4.80",
                "1.2.840.10008.1.2.4.57", "1.2.840.10008.1.2.4.90", "1.2.840.10008.1.2.4.91", "1.2.840.10008.1.2.5", "1.2.840.10008.1.2.4.100",
    ...
    public String toString() {
        return "DicomServicesImpl{" + "aetitle='" + aetitle + '\'' + ", deviceDescription='" + deviceDescription + '\'' + ", allowedAETitles=" + allowedAETitles
                + ", priorityAETitles=" + priorityAETitles + ", allowedLocalInterfaces=" + allowedLocalInterfaces + ", allowedHosts=" + allowedHosts
                + ", defaultTS=" + defaultTS + ", sopClasses=" + sopClasses + ", moveDestinations=" + moveDestinations + ", storage=" + storage
